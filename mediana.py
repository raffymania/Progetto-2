...
with open('C:\\Users\\Utente\Documents\\Raffaele Fiordoro\\coviddataaprire.csv', mode = 'r') as file:
    ...
    for i in leggi:
        ...
        if death_days.get(median(i['location']), None) is None:
            death_days(median([i]['location']) = {'mediana': i['new_deaths']}
        else:
            death_days[median(i['location']['mediana'])] = death_days[median(i['location'])]['mediana'] + i['new_deaths']
        print(death_days())
